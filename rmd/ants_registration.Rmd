...
plot( carmap$warpedmovout, doCropping=F )
```
...
```{r miex}
mitx = antsRegistration( r16, r64, typeofTransform = "SyN" )
cctx = antsRegistration( r16, r64, typeofTransform = "SyNCC",
        flowSigma = 1, gradStep = 0.2, totalSigma=0.0 )
ssdtx = antsRegistration( r16, r64, typeofTransform = "SyNLessAggro" )
```
...
cmap = antsRegistration( chalf, cfull,
