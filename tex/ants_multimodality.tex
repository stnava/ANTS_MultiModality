...
\setbeamertemplate{background}{\includegraphics[width=\paperwidth]{../figures/ants_background.pdf}}
...
\begin{itemize}
\item ROI study of cortical thickness
\pause 
\item template-study of thickness/gmprob, FA, connectivity ... 
\pause
\item multi-modality study of the relationship between modalities and
  predictors.
\pause
\item bold fmri study of resting state connectivity.
\pause
\item asymmetry study of neuroanatomy.
\pause
\item dimensionality reduction to increase detection power.  
\end{itemize}
\end{frame}
